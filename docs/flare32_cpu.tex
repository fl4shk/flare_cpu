...
\begin{document}
	...
	\subsection{Instruction Group 2:  ALU/Mul Instr without Immediate}
	The following encoding is used, with each character representing one
	bit:  \\
	...
	\subsection{Instruction Group 7.2:  Multiplies and Divides}
	The following encoding is used, with each character representing one
	bit:  \\
	...
	\begin{itemize}
		\item Opcode \texttt{0x0}:
			\texttt{\textbf{lumul}}
		\begin{itemize}
			\item Note:  This instruction multiplies \texttt{hi} by
