...
\begin{document}
	...
	\texttt{pre}, the 5-bit immediate would have been zero-extended.
	...
	%If \texttt{pre} is used with a relative branch, then bits 
	...
	\begin{itemize}
	%--------
	\item \texttt{i} is a 5-bit sign-extended or zero-extended immediate,
		and is denoted \texttt{simm} when sign-extended or \texttt{imm}
		when zero-extended. Also, \texttt{simm} or \texttt{imm} can be
		expanded with \texttt{pre} or \texttt{lpre}.
	...
	\item Opcode \texttt{0x1}:
		...
		% (for \texttt{add} immediate instruction) sign-extended.
	...
	\item Opcode \texttt{0xf}:
		...
		%--------
		\item Effect:
			Call software interrupt number \texttt{imm}.
		%--------
		\end{itemize}
	%\item Opcode \texttt{0xe}:
	%	\texttt{\textbf{seb} rA}
	...
	\begin{itemize}
	%--------
	\item \texttt{i} is a 9-bit sign-extended immediate,
		which can be expanded by \texttt{pre} or \texttt{lpre},
		and is denoted \texttt{simm}
	\item \texttt{o} is the opcode
	...
	\item \texttt{i} is a 5-bit sign-extended immediate, which can
		be expanded by \texttt{pre} or \texttt{lpre}, and is denoted
		\texttt{simm}
	\item \texttt{b} encodes register \texttt{rB}
	\item \texttt{a} encodes register \texttt{rA}
	%--------
	...
	\begin{itemize}
	%--------
	\item \texttt{\textbf{ldr} rA, [rB]}
		\begin{itemize}
		%--------
		\item This pseudo instruction assembles to the following:
			\begin{itemize}
			%--------
			\item \texttt{\textbf{ldr} rA, [rB, \#0x0]}
			%--------
			\end{itemize}
		%--------
		\end{itemize}
	\item \texttt{\textbf{ldr} rA, [rB, rC]}
		...
		\item This pseudo instruction assembles to the following:
			\begin{itemize}
			%--------
			\item \texttt{\textbf{index} rC}
			\item \texttt{\textbf{ldr} rA, [rB, \#0x0]}
			%--------
			\end{itemize}
		%--------
		\end{itemize}
	\item \texttt{\textbf{ldr} rA, [rB, rC, \#simm]}
		\begin{itemize}
		%--------
		\item This pseudo instruction assembles to the following:
			\begin{itemize}
			%--------
			\item \texttt{\textbf{index} rC}
			\item \texttt{\textbf{ldr} rA, [rB, \#simm]}
			%--------
			\end{itemize}
		%--------
		\end{itemize}
	...
	%The assembler will insert an \texttt{index rC} instruction before this
	%instruction if either of the following syntaxes:
	The following pseudo instructions exist within the assembler for this
	encoding group:
	\begin{itemize}
	%--------
	\item \texttt{\textbf{str} rA, [rB]}
		\begin{itemize}
		%--------
		\item This pseudo instruction assembles to the following:
			\begin{itemize}
			%--------
			\item \texttt{\textbf{str} rA, [rB, \#0x0]}
			%--------
			\end{itemize}
		%--------
		\end{itemize}
	\item \texttt{\textbf{str} rA, [rB, rC]}
		...
		%--------
		\end{itemize}
	\item \texttt{\textbf{str} rA, [rB, rC, \#simm]}
		\begin{itemize}
		%--------
		\item This pseudo instruction assembles to the following:
			\begin{itemize}
			%--------
			\item \texttt{\textbf{index} rC}
			\item \texttt{\textbf{str} rA, [rB, \#simm]}
			%--------
			\end{itemize}
		%--------
		\end{itemize}
	...
	%--------
	\item \texttt{o} is the opcode
	\item \texttt{b} encodes register \texttt{rB} or \texttt{sB}
	\item \texttt{a} encodes register \texttt{sA}
	%--------
	\end{itemize}
	\doublespacing
	...
	\subsection{Instruction Group 7, Subgroup \texttt{0b0110}:
		Icache Reload Instruction}
	The following encoding is used, with each character representing one
	bit: \\
	\texttt{1110 110i iiii aaaa}, where
	...
	\item \texttt{i} is a 5-bit sign-extended immediate, which can be
		expanded by \texttt{pre} or \texttt{lpre}, and is denoted
		\texttt{simm}.
	\item \texttt{a} encodes register \texttt{rA}
	%--------
	\end{itemize}
	...
	The one instruction from this encoding group  is
	\texttt{\textbf{icreload} [rA, \#simm]}.
	This instruction forcibly reloads the icache line at an effective
	address computed as \texttt{<index\_reg> + rA + simm}, using the
	sign-extended form of \texttt{simm}.
	...
	\begin{itemize}
	%--------
	\item \texttt{\textbf{icreload} [rA]}
		\begin{itemize}
		%--------
		\item This pseudo instruction assembles to the following:
			\begin{itemize}
			%--------
			\item \texttt{\textbf{icreload} [rA, \#0x0]}
			%--------
			\end{itemize}
		%--------
		\end{itemize}
	\item \texttt{\textbf{icreload} [rA, rC]}
		\begin{itemize}
		%--------
		\item This pseudo instruction assembles to the following:
			\begin{itemize}
		...
		%--------
		\end{itemize}
	\item \texttt{\textbf{icreload} [rA, rC, \#simm]}
		\begin{itemize}
		%--------
		\item This pseudo instruction assembles to the following:
			\begin{itemize}
			%--------
			\item \texttt{\textbf{index} rC}
			\item \texttt{\textbf{icreload} [rA, \#simm]}
			%--------
			\end{itemize}
		%--------
		\end{itemize}
