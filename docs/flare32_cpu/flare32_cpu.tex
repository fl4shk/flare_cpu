...
\begin{document}
	...
	\item \texttt{w} is the operation width
		...
		\item When \texttt{0b0}:
			8-bit operation;
			use \texttt{rA[7:0]} and \texttt{rB[7:0]}
		\item When \texttt{0b0}:
			16-bit operation;
			use \texttt{rA[15:0]} and \texttt{rB[15:0]}
		%--------
		\end{itemize}
	\item \texttt{o} is the opcode
	\item \texttt{b} encodes register \texttt{rB}
	...
	\item Opcode \texttt{0x1}:
		...
		\item \texttt{w} value \texttt{0b0}:
			...
			%--------
			\item Effect:
				Logical shift right \texttt{rA[7:0]} by \texttt{rB[7:0]}
			%--------
			\end{itemize}
		\item \texttt{w} value \texttt{0b1}:
			...
			%--------
			\item Effect:
				Logical shift right \texttt{rA[15:0]} by \texttt{rB[15:0]}
			%--------
			\end{itemize}
		%--------
		\end{itemize}
	\item Opcode \texttt{0x2}:
		...
		\item \texttt{w} value \texttt{0b1}:
			...
			\item Effect:
				Arithmetic shift right
					\texttt{rA[15:0]} by \texttt{rB[15:0]}
			%--------
			\end{itemize}
		%--------
		\end{itemize}
